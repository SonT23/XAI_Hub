...
> 🎓 **NCKH** / **Deep Learning** / [Autoencoder](autoencoder.md) / **Variational Autoencoder**

> 📌 **Nền tảng cần có trước:** **Autoencoder** · **Hàm mất mát Loss Function của Autoencoder** · [Latent Space (Không gian tiềm ẩn)](latent-space.md) · khái niệm **KL Divergence** trong bảng Thuật ngữ.
...
> 🗺️ Hãy coi Latent Space là một **tấm bản đồ**.
...
> 🔗 **β-VAE chính là cầu nối giữa Autoencoder và đề tài CBM của bạn:** nếu mỗi chiều latent mang một ý nghĩa độc lập, đó chính là **khái niệm không cần nhãn**. Xem [beta-VAE: Learning Basic Visual Concepts with a Constrained VAE](https://openreview.net/forum?id=Sy2fzU9gl) trong Thư viện bài báo.
...
imgs = model.decode(z)         # -> 16 chữ số viết tay CHƯA TẮNG TỒN TẠI
```
