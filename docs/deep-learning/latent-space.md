...
> 🎓 **NCKH** / **Deep Learning** / **Latent Space**
...
| **Feature Map** | Đầu ra của một lớp Conv, còn giữ **cấu trúc không gian** H×W×C | Là tensor **3 chiều**, chưa bị duỗi phẳng. Xem [Untitled](cnn.md) |
...
> Đây là lý do phải phân biệt **faithfulness** (giải thích có đúng với những gì mô hình thật sự làm không) và **plausibility** (giải thích nghe có hợp lý với người không). Xem [6. Đánh giá chất lượng lời giải thích](../xai/06-danh-gia.md).
>
