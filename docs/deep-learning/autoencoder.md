...
> **NCKH** / [Deep Learning](index.md) / **Autoencoder**
...
1. **Autoencoder**
2. **Hàm mất mát Loss Function của Autoencoder**
3. **Các Siêu tham số (Hyperparameters) quan trọng**
4. **Các biến thể phổ biến của Autoencoder**

> **🎲 Phần 5 — nằm ở ngoài hub này:** [Variational Autoencoder (VAE)](vae.md)
> VAE được tách thành một trang riêng trực thuộc [Deep Learning](index.md) vì nó không còn là một "biến thể nhỏ" nữa mà là một **mô hình sinh** với nền tảng xác suất riêng (ELBO, reparameterization trick).
...
>
> **Latent Space & Embedding** → nền tảng để hiểu **CBM**, biến thể thay khái niệm vô hướng bằng vector nhúng.
>
