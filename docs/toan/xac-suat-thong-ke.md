...
>
> Ba trang Toán gắn vào nhau như sau: [1. Đại số tuyến tính (Linear Algebra)](dai-so-tuyen-tinh.md) cho biết AI **tính** thế nào, [2. Giải tích (Calculus) — Đạo hàm, Tích phân & Gradient Descent](giai-tich.md) cho biết AI **học** thế nào, còn trang này cho biết AI **biểu diễn sự không chắc chắn** thế nào.
>
...
>
> Đây cũng chính là cặp $\mu, \sigma$ mà Encoder của [Variational Autoencoder (VAE)](../deep-learning/vae.md) xuất ra.
>
...
>
> **Đây là thành phần thứ hai trong hàm Loss của VAE** — xem mục 5 của [Variational Autoencoder (VAE)](../deep-learning/vae.md), nơi KL giữa phân phối latent và $N(0,I)$ được rút gọn thành một công thức đóng.
>
