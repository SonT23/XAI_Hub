...
>
> Nếu [1. Đại số tuyến tính (Linear Algebra)](dai-so-tuyen-tinh.md) trả lời câu hỏi *"AI TÍNH như thế nào"*, thì Giải tích trả lời câu hỏi *"AI HỌC như thế nào"*.
>
...
> 🔗 **Đây là điểm nối trực tiếp với đề tài của bạn.** Dòng thứ ba trong bảng — tích phân không tính nổi — chính là câu mở đầu của mục 2 trong [Variational Autoencoder (VAE)](../deep-learning/vae.md). Chữ **"Variational"** trong tên VAE ra đời **chỉ vì** người ta không tính được tích phân đó và phải đi đường vòng.
