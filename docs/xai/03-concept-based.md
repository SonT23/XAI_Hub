...
Nhóm phương pháp này chuyển đơn vị giải thích từ **pixel/đặc trưng thô** sang **khái niệm mà con người hiểu được** (ví dụ: "có sọc", "màu đỏ", "có bánh xe"). Đây là tiền đề trực tiếp dẫn tới [CBM](04-cbm.md).
