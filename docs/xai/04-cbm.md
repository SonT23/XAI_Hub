# 4. CBM — Concept Bottleneck Models

> **NCKH** / [XAI - Explainable AI](index.md) / **CBM**

**Concept Bottleneck Models (CBM)** là một dạng kiến trúc AI có khả năng giải thích nội tại (inherently interpretable): thay vì đi thẳng từ đầu vào đến nhãn dự đoán, mô hình được ép phải đi qua một tầng **khái niệm (concept)** trung gian mà con người có thể đọc và hiểu được, trước khi đưa ra kết quả cuối cùng.
...
### 2. Sequential Bottleneck (Huấn luyện Nối tiếp)
