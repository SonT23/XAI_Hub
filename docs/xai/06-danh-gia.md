...
> ⚠️ Hai tiêu chí này **có thể đối lập nhau**. Một lời giải thích rất plausible nhưng không faithful là **nguy hiểm nhất**: nó tạo cảm giác an tâm giả tạo, khiến người dùng tin vào một mô hình đang thực sự quyết định dựa trên lý do khác hẳn.
