...
> **Lưu ý quan trọng:** một lời giải thích **dễ hiểu** không tự động đồng nghĩa với **chính xác**. Đây chính là vấn đề "faithfulness" (độ trung thực) — sẽ học kỹ ở phần Đánh giá chất lượng lời giải thích.
