...
> 🎓 **NCKH** / **Cách đọc bài báo khoa học**
...
Phương pháp chuẩn trong giới nghiên cứu, do S. Keshav đề xuất: [How to Read a Paper](https://www.cs.princeton.edu/courses/archive/fall18/cos561/papers/HowToRead05.pdf) (ACM SIGCOMM CCR, Vol. 37 No. 3, tháng 7/2007, tr. 83–84). Bản dịch đầy đủ nằm trong trang đó.
...
- **Ghi ra từ khóa lạ** nhưng **đừng dừng lại để tra ngay** — tra một lượt sau khi hết mục, kếo mất mạch.
...
Chỉ làm vòng này với các bài **cốt lõi** của đề tài — với bạn lúc này là CBM gốc và 1–2 bài nữa, không phải mọi bài.
...
**Báo cáo kỹ thuật (technical report)** — ví dụ NIST IR 8312 bạn đang đọc. Đặc điểm: **không có thực nghiệm, không đề xuất mô hình mới**, mục tiêu là **định khung khái niệm** hoặc đưa chuẩn. Cách đọc: tìm **các định nghĩa và phân loại**, đọc không theo thứ tự, bắt đầu từ mục cốt lõi nhất.
...
**Blog nghiên cứu của lại (DeepMind, Anthropic, OpenAI)** — không qua bình duyệt nhưng thường rất mới và thẳng thắn. **Không dùng làm nguồn trích dẫn chính** trong bài báo, nhưng rất tốt để nắm xu hướng.
...
- [S. Keshav — ](https://web.stanford.edu/class/ee384m/Handouts/HowtoReadPaper.pdf)[*How to Read a Paper*](https://web.stanford.edu/class/ee384m/Handouts/HowtoReadPaper.pdf)[ (ACM SIGCOMM CCR, 2007)](https://web.stanford.edu/class/ee384m/Handouts/HowtoReadPaper.pdf) — nguồn gốc của phương pháp 3 vòng, chỉ 3 trang, nên đọc bản gốc.
...
> 🧭 **Áp dụng vào đề tài cụ thể:** thứ tự 14 bài nên đọc, kiến thức nền cần có trước mỗi bài, nhịp độ đọc và cách tìm bài mới — xem [Lộ trình đọc bài báo & kiến thức nền](lo-trinh-doc.md)
