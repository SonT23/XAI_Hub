...
> 🎓 **NCKH** / **Lộ trình đọc bài báo**
> Phương pháp đọc: [Cách đọc một bài báo khoa học / báo cáo học thuật](cach-doc-bai-bao.md)
>
...
**Kiến thức cần có trước:** [1. Tổng quan & Phân loại XAI](../xai/01-tong-quan.md)

**Đọc xong thì cập nhật vào:** [6. Đánh giá chất lượng lời giải thích](../xai/06-danh-gia.md)
...
**Kiến thức cần có trước:** [3. Phương pháp dựa trên khái niệm (Concept-based)](../xai/03-concept-based.md) · khái niệm **CAV** trong bảng Thuật ngữ.
...
**Kiến thức cần có trước:** ba cách huấn luyện CBM (Independent / Sequential / Joint) — [Các Phương Pháp Huấn Luyện](../xai/04-cbm.md)

#### 4. If Concept Bottlenecks are the Question... — 04/2026
...
**Kiến thức cần có trước — quan trọng:** [CLIP & Mô hình đa phương thức (Vision-Language)](../deep-learning/clip.md). Không nắm CLIP thì không đọc được bài này.
...
**Kiến thức cần có trước:** **Autoencoder** — khái niệm **Latent Space** và **Embedding**. Đây là chỗ kiến thức Autoencoder đã học nối vào đề tài CBM.
...
**Đọc xong cập nhật vào:** [5. Các biến thể & cải tiến của CBM](../xai/05-bien-the-cbm.md)
...
#### 9. Measuring What Matters (Benchmark) — 06/2026
...
**Kiến thức cần có trước:** [7. Bộ dữ liệu & Công cụ](../xai/07-du-lieu-cong-cu.md) · [Performance Measures](../ml-co-ban/performance-measures.md)
...
**Kiến thức cần có trước:** [CNN](../deep-learning/cnn.md) · [2. Các phương pháp hậu kỳ (Post-hoc)](../xai/02-post-hoc.md)
...
→ [beta-VAE: Learning Basic Visual Concepts with a Constrained VAE](https://openreview.net/forum?id=Sy2fzU9gl)

**Kiến thức cần có trước:** [Variational Autoencoder (VAE)](../deep-learning/vae.md)

**14. Negative Results for SAE — DeepMind, 03/2025** — khác nhánh, đọc lấy bài học phương pháp luận.

→ [Negative Results for Sparse Autoencoders on Downstream Tasks (DeepMind)](https://deepmindsafetyresearch.medium.com/negative-results-for-sparse-autoencoders-on-downstream-tasks-and-deprioritising-sae-research-6cadcfc125b9)
...
**Không ghi chú thì coi như chưa đọc.** Sau 2 tuần bạn sẽ không nhớ gì. Ghi vào **Thư viện bài báo** ngay trong buổi đọc, đừng để hôm sau.
...
>
> **Thứ 6:** bổ sung thuật ngữ mới vào **Thuật ngữ Anh - Việt**, cập nhật **Nhật ký học tập**.
>
...
> 🎯 **Nếu tìm được survey thì việc tìm kiếm KẾT THÚC** — chỉ cần đọc nó. Bạn đã có sẵn [What's in the Bottle? A Survey and Roadmap of Concept Bottleneck Models](https://arxiv.org/abs/2603.05629) rồi, nên bước này với đề tài CBM coi như đã xong.
